    ...
    <div className="max-w-7xl mx-auto p-4">
      ...
      <section className="flex flex-col md:flex-row items-center gap-8 bg-gradient-to-r from-blue-50 to-white rounded-xl p-8 mb-12 shadow-lg">
        <div className="flex-1">
          ...
          <Link to="/products" className="inline-block bg-blue-700 text-white px-8 py-3 rounded-lg font-semibold shadow hover:bg-blue-800 transition">Shop Now →</Link>
        </div>
        ...
        <div className=" gap-8 items-center bg-white rounded-xl shadow-lg p-8">
          ...
          <div>
            ...
            <p className="mb-4 text-lg text-gray-700">
              <span className="font-bold text-blue-800">BAKGAB Interiors</span> is where craftsmanship meets inspiration. We believe that great spaces inspire better living, and our mission is to bring timeless comfort, style, and purpose into every home and office.
            </p>
            ...
            <div className="mt-2">
              <h4 className="font-semibold mb-3 text-blue-700">What We Offer</h4>
      ...
      {/* Featured Products */}
      <section>
        <h2 className="text-2xl font-bold mb-6 text-blue-800">🛍️ Featured Products</h2>
